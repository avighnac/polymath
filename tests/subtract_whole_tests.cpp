...
TEST(subtract_whole_tests, big_test_1) {
  ...
  ASSERT_EQ(result->contents[1], 470982730);
  ASSERT_EQ(result->contents[2], 470198245);
  ASSERT_EQ(result->contents[3], 470243536);
  ASSERT_EQ(result->contents[4], 318390097);
  ASSERT_EQ(result->number_of_decimal_digits, 0);
  plm_free(a);
  plm_free(b);
  plm_free(result);
...
TEST(subtract_whole_tests, big_test_3) {
  ...
  ASSERT_EQ(result->contents[1], 497265017);
  ASSERT_EQ(result->contents[2], 682501912);
  ASSERT_EQ(result->contents[3], 82574886);
  ASSERT_EQ(result->contents[4], 364914309);
  ASSERT_EQ(result->number_of_decimal_digits, 0);
  plm_free(a);
  plm_free(b);
  plm_free(result);
